const quizData = [
  {
    question:
      "Complete a frase: Um banco de dados _______ é um tipo de banco de dados que fornece acesso a pontos.. ",
    a: "Relacional",
    b: "Mysql",
    c: "java script",
    d: "Vai saber ",
  ...
  {
    question: "As colunas de uma tabela, também sao chamadas de:",
    a: "Atributos.",
    b: "Não faço ideia",
    c: "Variaveis",
    d: "Codigos",
  ...
  },
  {
    ...
    a:
      "Um tipo de banco de dados que armazena e fornece acesso a pontos de dados relacionados entre bancos.",
    b: "Um tipo de dado.",
    c: "Uma forma de conversar com o backend de uma aplicação.",
    d:
      "Um tipo de banco de dados que armazena e fornece acesso a pontos de dados relacionados entre si.",
    correct: "d",
  },
  {
